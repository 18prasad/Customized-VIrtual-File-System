...
#define MAXINODE 5  // Max files can be created
...
void man(char *name)
{
    ...
    {
        printf("ERROR : No manual entry availaible\n");
    }
...
void DisplayHelp()
{
    printf("ls : To list all information of file\n");
    printf("clear : To clear the console\n");
    printf("open : To open existing file\n");
    printf("close : To close opened file\n");
    printf("closeall : To close all opened file\n");
    printf("read : To read data from regular file\n");
    printf("write : To write content into file\n");
    printf("exit :To terminate file system\n");
    printf("stat : To display information of file using name\n");
    printf("fstat : To display all information of file\n");
...
int fstat_file(int fd)
{
    ...
    printf("File name: %s\n", temp->FileName);
    printf("Incode Number %d\n", temp->InodeNumber);
    printf("File size : %d\n", temp->FileSize);
    printf("Actual File Size : %d\n", temp->FileActualSize);
    printf("Link count : %d\n", temp->ReferenceCount);

    if(temp->permission == 1)
        printf("File Permisiion : Read Only\n");
    else if(temp->permission == 2)
        printf("File Permisiion : Write Only\n");
    else if(temp->permission == 3)
        printf("File Permisiion : Read and Write\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                printf("Terminatig the Virtual File System\n");
                break;
            }
            else
            {
